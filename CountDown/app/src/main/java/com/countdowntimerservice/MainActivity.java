...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button btn_start, btn_cancel,btn_exit;
...
/*
            ...
            case R.id.btn_exit:
                Intent intent2 = new Intent(getApplicationContext(),Timer_Service.class);
                stopService(intent2);
                mEditor.clear().commit();
                et_hours.setEnabled(true);
                btn_start.setEnabled(true);
    ...
    public void onBackPressed() {
        ...
        builder.setMessage("Click exit button to exit");
